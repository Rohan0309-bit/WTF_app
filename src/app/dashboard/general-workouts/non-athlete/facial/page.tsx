...
import { MALE_FACIAL_WORKOUT_PLAN, FEMALE_FACIAL_WORKOUT_PLAN, WorkoutSplit } from '@/lib/workouts';
...
export default function FacialWorkoutPage() {
  ...
  const getWorkoutPlan = (): WorkoutSplit => {
    return gender === 'male' ? MALE_FACIAL_WORKOUT_PLAN : FEMALE_FACIAL_WORKOUT_PLAN;
  };
