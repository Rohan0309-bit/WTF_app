...
export const FEMALE_CHEST_HOME: DayWorkout = {
  ...
  exercises: [
    ...
    { ...defaultExerciseProps, name: "Incline Push-Ups (Bench/Chair)", sets: "3", reps: "15", rest: "60s", ...MASTER_EXERCISE_DATA["Incline Push-Ups"] },
...
export const FOOTBALL_MALE_GYM_WORKOUT_PLAN: WorkoutSplit = { "Monday": { "focus": "Placeholder", "exercises": [] }, "Tuesday": { "focus": "Placeholder", "exercises": [] }, "Wednesday": { "focus": "Placeholder", "exercises": [] }, "Thursday": { "focus": "Placeholder", "exercises": [] }, "Friday": { "focus": "Placeholder", "exercises": [] }, "Saturday": { "focus": "Placeholder", "exercises": [] }, "Sunday": { "focus": "Placeholder", "exercises": [] } };
...
export const FOOTBALL_FEMALE_GYM_WORKOUT_PLAN: WorkoutSplit = { "Monday": { "focus": "Placeholder", "exercises": [] }, "Tuesday": { "focus": "Placeholder", "exercises": [] }, "Wednesday": { "focus": "Placeholder", "exercises": [] }, "Thursday": { "focus": "Placeholder", "exercises": [] }, "Friday": { "focus": "Placeholder", "exercises": [] }, "Saturday": { "focus": "Placeholder", "exercises": [] }, "Sunday": { "focus": "Placeholder", "exercises": [] } };
